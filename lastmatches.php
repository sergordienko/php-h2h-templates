...
<div class="comparison-teams-list d-flex flex-column gap-2">
	...
	<div class="comparison-teams-list-content d-flex flex-column">
		...
		<div class="ui tabs light d-flex gap-2">
			<?php foreach( $data->br->head2head[ 'lastmatches' ] as $tab => $team ): ?>
				<?php $active = $tab == array_key_last( $data->br->head2head[ 'lastmatches' ] ) ? ' active' : ''; ?>
				<span class="tips item br-clr-regular<?php echo $active; ?>" data-tab="<?php echo $tab . '_last'; ?>">
		...
		<?php foreach( $data->br->head2head[ 'lastmatches' ] as $tab => $team ): ?>
			...
			<div class="ui tab segment mt-3<?php echo $active; ?>" data-tab="<?php echo $tab . '_last'; ?>">
